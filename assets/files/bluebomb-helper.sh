...
download() {
    ...
    wget -q --secure-protocol=TLSv1_2 "https://github.com/Fullmetal5/bluebomb/releases/download/1.5/bluebomb1..zip" -O bluebomb.zip
    printf "Success!\n\n* Unpacking BlueBomb... "
...
execute() {
    ...
    printf "* Stopping the Bluetooth service... "
    case "$init" in
