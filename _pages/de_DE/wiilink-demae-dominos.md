...
3. Follow the on-screen instructions, then click `Order` in the main menu. ![Hauptmenü](/images/Demae-Dominos/main-menu.png)
4. You will now be prompted to select your region. Be sure to select your residing country correctly. Failure to do so will result in restaurants failing to load. You will then be prompted to select your state/province, then city. If your city is not on the list, you can select any one as it does not matter. ![Hauptmenü](/images/Demae-Dominos/country-setup.png)
