...
3. Press the + Button on Wii Remote or the A Button on a GameCube controller. ![Installiere Priiloader](/images/Priiloader/installer.png) ![Installiere](/images/Priiloader/installing.png)
...
4. We recommend you turn on the following hacks: `Region Free EVERYTHING`, `Block Disc Updates` and `Block Online Updates`. ![Systemmenü-Hacks](/images/Priiloader/hacks.png)
