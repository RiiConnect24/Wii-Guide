...
Zwar ist es möglich, BootMii auf einer Wii Mini zu installieren, allerdings müsstest du dafür einen SD-Kartenslot anlöten. That requires opening up your Wii mini and using special tools, so it is not recommended.
{: .notice--info}
