...
Verwende diese Anleitung **NICHT** auf irgendeiner anderen Konsole als der vWii (Wii-Modus auf der Wii U). Falls du nach Anweisungen für die Nintendo Wii suchst, verwende [diese Anleitung](riiconnect24). Wenn du diese Anleitung im Dolphin-Emulator verwenden möchtest, benutze stattdessen [diese Anleitung](riiconnect24-dolphin).
{: .notice--warning}
