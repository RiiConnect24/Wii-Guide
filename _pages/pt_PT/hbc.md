...
7. If you cannot install BootMii as boot2 (like the Wii shown in step two), install BootMii as IOS instead. Mesmo que isto não te dê nenhuma proteção de brick, tu continuas a poder fazer uma cópia da NAND.
