...
This guide is for the original Wii only, with the latest firmware (4.3), and the Wii mini. אין להשתמש במדריך זה כדי לפרוץ vWii או Wii U! If you want to install homebrew on vWii, [follow this tutorial](https://wiiuguide.xyz/#/vwii-modding).
{: .notice--warning}
