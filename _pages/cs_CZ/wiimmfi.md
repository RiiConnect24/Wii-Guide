...
2. Zvolte možnost `System Menu Hacks`.
...
3. Zadejte `164.132.44.106` jako primární DNS.
4. Zadejte `1.1.1.1` jako sekundární DNS (pokud vám to působí problémy, zkuste `8.8.8.8`).
