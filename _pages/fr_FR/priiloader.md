...
| Block Online Updates                    | Désactive les mises à jour de votre Wii. Updates will fail with error 32007.                                                                                        |
...
| Force Disc Games to run under IOS249    | Force les applications disque à utiliser le cIOS 249 comme IOS du jeu. While it cannot allow playing of burned games on its own, it is needed to play burned discs. |
