...
4. Нажмите 1 для выбора "`Start`" и подтвердите выбор нажатием `Enter`. (NOTE: These screenshots are from the Windows version of the patcher.) ![RiiConnect24 Patcher Main Screen](/images/RC24_Patcher/1.JPG)
...
Если вы получаете ошибку FORE000006, часы вашей Wii скорее всего установлены некорректно. Set it to the correct date and time, then wait no more than an hour and the Forecast Channel may start working.
{: .notice--warning}
