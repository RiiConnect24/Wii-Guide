...
8. Guarda el archivo XML en la carpeta `/apps/usbloader_gx/lt;/code> en la tarjeta SD o unidad USB, reemplazando el archivo <code>Wiinnertag.xml` ya existente.
