...
1. Press `Continue`, then select `Install The Homebrew Channel`. ![Homebrew Channel 安装](/images/hackmii/hbc_install.png) ![Homebrew Channel 安装成功](/images/hackmii/hbc_install_ok.png)
