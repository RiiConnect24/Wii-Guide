...
* Μια κάρτα SD ή μια συσκευή USB (αν χρησιμοποιήτε κάρτα SD, να σιγουρευτήτε πως ο διακόπτης για την κλείδωση είναι στην ανοιχτή θεση, αλλίώς δεν θα δείτε τις σωστές ενδείξεις για cIOS)
