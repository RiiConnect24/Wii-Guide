...
1. Ενεργοποιήστε την κονσόλα σας και πηγαίνετε στις ρυθμίσεις. On the top right corner you should see a 4-character code like the one in the picture below. Αυτή είναι η έκδοση Μενού Συστήματος, σημειώστε την καθώς θα την χρειαστείτε αργότερα. Ύστερα, απενεργοποιήστε την κονσόλα σας. ![SystemMenuVersion](/images/Wii/SystemMenuVersion.png)
...
1. Το πρόγραμμα θα κατεβάσει τα απαραίτητα αρχεία και θα ζητήσει πληροφορίες για την κονσόλα σας.
  - Αν έχετε Wii mini, θα ζητηθεί η περιοχή της κονσόλας. This can be determined by the last letter of the System Menu version (`U` for **USA** and `E` for **PAL** models).
