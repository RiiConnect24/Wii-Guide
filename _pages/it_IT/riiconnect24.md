...
1. Su Windows avvia `RiiConnect24Patcher.bat`. On Unix systems, open terminal and type `bash`, then drag `RiiConnect24Patcher.sh`into the terminal then press enter. Dovrebbe sembrare così `bash RiiConnect24Patcher.sh`.
