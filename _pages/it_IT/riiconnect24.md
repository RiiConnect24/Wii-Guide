...
16. Highlight all the WADs in the folder by pressing the + Button to select them. Quando sono tutti selezionati, premi A due volte per installare tutti i WAD.
