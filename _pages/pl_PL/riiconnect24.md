...
NIE ZAINSTALUJ RIICONNECT24 NA WII MINI! To nie zadziała, a system będzie blokował.
{: .notice--danger}
...
Jeśli pojawi się błąd 107245, to nie zainstalowałeś patchowanego IOS.
{: .notice--warning}

Jeśli pojawi się błąd 107304 lub zobaczysz umowę użytkownika Nintendo bez logo RiiConnect24, Oznacza to, że Twój dostawca usług internetowych (dostawca usług internetowych) lub sieć blokuje korzystanie z DNS. Możesz ustawić `Auto-Uzyskiwanie` DNS na `Na` jeśli tak się stanie. RiiConnect24 wciąż będzie działał bez tego. Lub możesz użyć naszego [serwera DNS-](https://github.com/RiiConnect24/DNS-Server/releases/latest).
{: .notice--warning}
...
[Jeśli nadal otrzymasz FORE000006 lub jeśli otrzymasz NEWS000006, musisz usunąć SYSCONF za pomocą narzędzia rc24-clear-tool](https://github.com/RiiConnect24/rc24-clear-tool/releases/latest).
{: .notice--warning}

[Jeśli pojawiają się jakiekolwiek inne błędy z kanałem Prognoza lub kanałem informacyjnym, np. kod błędu zaczynający się od FORE lub NEWS lub przerwaną wiadomość, możesz spróbować usunąć swoje VFFy za pomocą narzędzia rc24-clear-tool.](deleting-vffs)
{: .notice--warning}
