...
6. W Dolphin'ie, naciśnije na `Narzędzia (Tools)` a potem `Zainstaluj WAD (Install WAD)`. oraz wybierz `Mii Contest Channel (Europe) (Channel) (RiiConnect24).wad` lub `Check Mii Out Channel (USA) (Channel) (RiiConnect24).wad`.
