...
2. It should only take a few seconds to patch your nwc24msg.cfg. When it's done, press HOME to exit. When it's done, press the HOME Button to exit. When it's done, press the HOME Button to exit.
...
16. Finally, go to the `Internet` section, then `User Agreements` or `Agreement/Contact`, then `Yes`. Please read through this. Please read through this. Please read through this.
