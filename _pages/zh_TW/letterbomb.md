...
1. Take out your SD card and insert it in your Wii.
   - The SD card must be inserted in the SD card slot located in the front of the Wii. Using a USB adapter plugged into the Wii's USB port will not work. Using a USB adapter plugged into the Wii's USB port will not work.
...
1. Load the red letter with a bomb icon.
   ...
   - If your Wii freezes after clicking on the letter, you probably chose the wrong region when downloading the exploit. Redo Step 2 and select the correct region. Redo Step 2 and select the correct region.
