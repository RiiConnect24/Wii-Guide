...
These instructions will assume you're using an SD card to mod your Wii with, and while you can use a USB storage device instead, there are some situations, including BootMii, where you will have to use an SD card. To use the exploits, LetterBomb requires a SD card, and BlueBomb requires a USB storage device.
{: .notice--info}
