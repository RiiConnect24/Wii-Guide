...
Although you can follow this guide without an SD card, you will not be able to create or restore a NAND backup using BootMii, and you may not be able to use some homebrew.
{: .notice--info}
