...
Make sure your USB drive is formatted as FAT32. Do not format it as other types such as exFAT or extFS. <br>You may also use NTFS or WBFS, but NTFS will only work with apps like USB Loader GX, and WBFS is and old format that can only store Wii games.
{: .notice--info}
