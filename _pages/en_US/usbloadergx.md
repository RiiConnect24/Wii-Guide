...
Make sure your USB drive is formatted as FAT32. Do not format it as other types such as exFAT or extFS. <br>You may also use NTFS or WBFS, but NTFS doesn't work with Nintendont or The Homebrew Channel, and WBFS is an old filesystem that can only store Wii games.
{: .notice--info}
