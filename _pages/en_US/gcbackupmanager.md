...
4. Next, go back to the `Files (Source)` tab and click on the `Install Game (1:1)` or `Install Game (Scrub)` option. This will begin the transfer process and ensure that the game is transferred in its original state. For best results, it's recommended to use this option.
