...
1. The helper will then download the required files, and ask for information about your console.
  ...
  - If you have selected a Wii you will be asked to provide your Wii Menu Version (will probably be 4.3U)
...
The console should now boot to the HackMii installer. The exploit is sent directly to the Wii with Bluetooth. You can now shutdown your Linux computer if you are not planning to use it later.
