...
| L = Load Download Queue: Nintendo could possibly shut down their servers!
      Download from NUS while you still can! After ModMii's downloaded
      files to its temp folder for future use you can delete 'COPY_TO_SD'          | This option will download all of the required titles need for the Wii system menu (titles are downloaded from NUS)                                                                                                                         |
