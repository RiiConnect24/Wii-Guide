...
Αν χρειάζεστε βοήθεια με οτιδήποτε σχετικά με αυτόν τον οδηγό, παρακαλούμε επισκεφθείτε [ τον διακομιστή Wii Mini Hacking στο Discord](https://discord.gg/6ryxnkS) (προτείνεται)
{: .notice--info}
